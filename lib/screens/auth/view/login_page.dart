...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
    ...
    _debounceTimer = Timer(_debounceDuration, () {
      if (_identifierController.text.trim() == value.trim()) {
        if (type == 'email') {
          ...
          context.read<UserVerificationBloc>().add(VerifyUser(value: _normalizePhone(value), type: 'mobile'));
        }
      }
    });
  }
  ...
  void _handleLogin() {
    ...
    context.read<AuthBloc>().add(LoginRequest(
      ...
      phoneNumber: _isValidPhone(identifier) ? _normalizePhone(identifier) : null,
