...
class AppTheme {
  /// App main color
  static const Color primaryColor = Color(0xFFF75200);
  ...
  static const Color lightSubCategoryCardColor = Color(0xFFF6F5F5);
  ...
  static const Color deliveryTimeWidgetColor = Color(0xFFF75200);
